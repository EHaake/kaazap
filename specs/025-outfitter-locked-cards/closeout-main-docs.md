...
The `CLAUDE.md` amendment landed on `main` in `3777553` before the merge, in
its own commit as the constitution requires; nothing further to apply here (see
§3). Spec 025 changed no *product* rule the constitution states.
