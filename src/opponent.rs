...
pub const OPPONENTS: [OpponentProfile; 10] = [
    OpponentProfile {
        ...
        // Still the roster's highest slip rate, but it is the all-1s deck — not
        // the slips — that makes the rookie lose (T004a).
        misplay: 0.18,
    ...
    OpponentProfile {
        ...
        misplay: 0.16, // green and reckless — pushes, and slips a little
